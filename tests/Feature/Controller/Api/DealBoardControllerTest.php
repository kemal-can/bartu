...
class DealBoardControllerTest extends TestCase
{
    public function test_unauthenticated_user_cannot_access_deals_board_endpoints()
    {
        ...
        $this->getJson('/api/deals/board/FAKE_PIPELINE_ID/summary')->assertUnauthorized();
        $this->postJson('/api/deals/board/FAKE_ID')->assertUnauthorized();
        $this->postJson('/api/deals/board/FAKE_ID/sort')->assertUnauthorized();
    }
    ...
    */
    ...
    public function test_deals_board_sorting_can_be_saved()
    {
        $this->signIn();

        $pipeline = Pipeline::factory()->create();

        $this->postJson('/api/deals/board/' . $pipeline->getKey() . '/sort', [
            'direction' => 'asc',
            'field'     => 'expected_close_date',
        ])->assertJsonPath('user_default_sort_data.direction', 'asc')
            ->assertJsonPath('user_default_sort_data.field', 'expected_close_date');
    }
}
