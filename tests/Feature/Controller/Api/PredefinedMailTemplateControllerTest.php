...
class PredefinedMailTemplateControllerTest extends TestCase
{
    public function test_unauthenticated_user_cannot_predefined_mail_templates_endpoints()
    {
        ...
        $this->putJson('/api/mails/templates' . '/FAKE_ID')->assertUnauthorized();
        $this->getJson('/api/mails/templates' . '/FAKE_ID')->assertUnauthorized();
        $this->deleteJson('/api/mails/templates' . '/FAKE_ID')->assertUnauthorized();
    }
