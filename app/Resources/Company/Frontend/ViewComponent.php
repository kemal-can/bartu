...
namespace App\Resources\Company\Frontend;
...
class ViewComponent extends Component implements JsonSerializable
{
    ...
    protected function init() : void
    {
        ...
        static::registerSections([
            ...
            Section::make('contacts', 'contacts-section')->heading(__('contact.contacts')),
            Section::make('media', 'media-section')->heading(__('app.attachments')),
            Section::make('child', 'child-companies-section')->heading(trans_choice('company.child', 2)),
        ]);
    }
