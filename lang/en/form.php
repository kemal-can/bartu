...
return [
    ...
    'inactive_info'                  => 'This form is inactive, you are able to preview the form because you are logged in, if you want to form to be publicly available, make sure to set the form as active.',
