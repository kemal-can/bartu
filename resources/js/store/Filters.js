...
import { getDefaultQuery } from '@/components/QueryBuilder/Utils'
...
const actions = {
   ...
   * @return {Void}
   */
  toggleFiltersRules({ getters, commit }, data) {
    commit('SET_RULES_VISIBLE', {
      identifier: data.identifier,
      view: data.view,
      visible: !getters['rulesAreVisible'](data.identifier, data.view),
    })
  },
