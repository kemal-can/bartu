...
return [
    ...
    */
     ...
     */
    'import' => [
        'invalid' => 'Some of your rows contains the following validation error: :message',

        'dependent' => 'Some of your :attribute rows does not belong to the :dependsOn, make sure that the :attribute is related to the :dependsOn.',
