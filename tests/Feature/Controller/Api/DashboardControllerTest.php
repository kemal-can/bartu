...
class DashboardControllerTest extends TestCase
{
    ...
    public function test_dashboard_requires_name()
    {
        ...
        $this->putJson('/api/dashboards/FAKE_ID', [
            'name' => '',
        ])->assertJsonValidationErrors(['name']);
    }
    ...
    {
        $user      = $this->signIn();
        $dashboard = resolve(DashboardRepository::class)->createForUser(
        ...
        $this->putJson('/api/dashboards/' . $dashboard->id, [
            ...
            ->assertJson(['name' => '--changed-name--', 'is_default' => true])
    ...
    {
        $user      = $this->signIn();
        $dashboard = resolve(DashboardRepository::class)->createForUser(['name' => 'Name'], $user->id);
    ...
    public function test_unauthorized_user_cannot_delete_dashboard()
    {
        $this->asRegularUser()->signIn();
        $otherUser = $this->createUser();
        $dashboard = resolve(DashboardRepository::class)->createForUser(['name' => 'Name'], $otherUser->id);
