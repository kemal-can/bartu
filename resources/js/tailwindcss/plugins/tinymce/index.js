...
module.exports = plugin(function ({ addComponents }) {
  addComponents({
    // Typography
    '.wysiwyg-text': {
      '@apply prose prose-sm prose-neutral max-w-none prose-headings:my-3 prose-headings:font-semibold dark:prose-invert prose-a:text-primary-600 hover:prose-a:text-primary-900':
        {},
    },
