...
class DealStatusChanged extends Trigger implements FieldChangeTrigger, ModelTrigger
{
    ...
    */
    ...
    {
        return __('deal.workflows.triggers.status_changed');
    }
    ...
    */
    public static function changeField()
    {
        return Select::make(static::field())->options([
            DealStatus::won->name  => __('deal.status.won'),
            DealStatus::lost->name => __('deal.status.lost'),
            DealStatus::open->name => __('deal.status.open'),
        ]);
    }
