...
return [
    ...
    'related'     => ':name Deal | :name Deals',
    'name'        => 'Deal Name',
    'count_total' => ':total deals',
    'reopen'      => 'Reopen',
    'status'      => [
        'status' => 'Status',
        'won'    => 'Won',
    ...
    'pipeline' => [
        ...
        'remember_sorting_info'          => 'The sorting will be remembered for :name pipeline.',
        'previous_remember_sorting_note' => 'Note that your previously remembered sort options for :name pipeline will be overwritten.',
    ...
    'timeline' => [
        'deleted'  => 'The deal has been deleted by :causer',
        'restored' => 'The deal has been restored from trash by :causer',
        'created'  => 'Deal has been created by :causer',
        'updated'  => 'Deal has been updated by :causer',

        'stage' => [
            'moved' => ':user moved deal from :previous to :stage stage',
        ],

        'attached' => ':user associated deal',
        'detached' => ':user dissociated deal',
        ...
        'associate_trashed' => 'The associated :dealName deal has been moved to trash by :user',
    ],
