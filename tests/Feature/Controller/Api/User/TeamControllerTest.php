...
class TeamControllerTest extends TestCase
{
    public function test_unauthenticated_cannot_access_teams_endpoints()
    {
        ...
        $this->getJson('/api/teams/FAKE_ID')->assertUnauthorized();
        $this->postJson('/api/teams')->assertUnauthorized();
        $this->putJson('/api/teams/FAKE_ID')->assertUnauthorized();
        $this->deleteJson('/api/teams/FAKE_ID')->assertUnauthorized();
    }
    ...
    public function test_unauthorized_user_cannot_access_teams_endpoints()
    {
        ...
        $this->putJson('/api/teams/FAKE_ID')->assertForbidden();
        $this->deleteJson('/api/teams/FAKE_ID')->assertForbidden();
    }
    ...
    public function test_user_can_create_team()
    {
        ...
        $this->postJson('/api/teams', ['name' => 'Team', 'description' => 'Description', 'members' => [$user->id]])
            ->assertStatus(201)
            ->assertJson([
                'name'        => 'Team',
    ...
    public function test_team_requires_name()
    {
        ...
        $this->putJson('/api/teams/FAKE_ID')
            ->assertJsonValidationErrors(['name']);
    }
    ...
    public function test_team_requires_numeric_members()
    {
        ...
        $this->putJson('/api/teams/FAKE_ID', ['members' => ['test']])
            ->assertJsonValidationErrors(['members.0']);
    }
