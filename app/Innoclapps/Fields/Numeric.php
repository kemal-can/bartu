...
class Numeric extends Field implements Customfieldable
{
     ...
     * @var string
     */
    public $component = 'numeric-field';
    ...
    public function __construct($attribute, $label = null)
    {
        ...
        $this->rules(new NumericFieldCheckRule)
    ...
    public function resolveForDisplay($model)
    {
        ...
        if ($this->currency) {
            $value = $this->toMoney($value)->format();
        }
     ...
     *
     * @return \App\Innoclapps\Table\NumericColumn
     */
    ...
    /**
     * Convert the given value to Money instance
     *
     * @param mixed $value
     *
    ...
    {
        return new Money($value, $this->currency, true);
    }
}
