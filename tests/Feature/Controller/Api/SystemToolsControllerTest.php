...
class SystemToolsControllerTest extends TestCase
{
    ...
    {
        $this->getJson('/api/tools/i18n-generate')->assertUnauthorized();
    ...
    public function test_unauthorized_user_cannot_access_system_tools_endpoints()
    {
        ...
        $this->getJson('/api/tools/i18n-generate')->assertForbidden();
    ...
    public function test_i18_generate_tool_can_be_executed()
    {
        ...
        $this->getJson('/api/tools/i18n-generate')->assertOk();

        $this->assertLessThanOrEqual(2, Carbon::parse(filemtime(config('innoclapps.lang.json')))->diffInSeconds());
    }
