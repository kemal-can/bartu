...
class DealsLostInStage extends DealPresentationCard
{
    ...
    */
    ...
    public function calculate(Request $request)
    {
        $repository = resolve(DealRepository::class)
            ...
            ->pushCriteria(LostDealsCriteria::class);

        return $this->withStageLabels(
            $this->byMonths('lost_date')->count($request, $repository, 'stage_id')
        );
    }
    ...
    */
    ...
    {
        return __('deal.cards.lost_in_stage');
    }
    ...
    */
    public function jsonSerialize() : array
    {
        return array_merge(parent::jsonSerialize(), [
            'help' => __('deal.cards.lost_in_stage_info'),
        ]);
    }
}
