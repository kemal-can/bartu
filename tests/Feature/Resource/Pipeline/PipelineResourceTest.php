...
namespace Tests\Feature\Resource\Pipeline;
...
class PipelineResourceTest extends ResourceTestCase
{
    ...
    public function test_admin_user_can_see_all_pipelines()
    {
        ...
        $vGroup          = new ModelVisibilityGroup(['type' => 'teams']);
        $visibilityGroup = $this->factory()->create()->visibilityGroup()->save($vGroup);
        $visibilityGroup->teams()->attach($team);
